...
func Execute(s *service.MemoryService, ss *service.SessionService, suc *usecase.SyncMemoriesUseCase, stuc *usecase.SuggestTopicUseCase, tuc *usecase.GetTimelineUseCase, sumuc *usecase.SummarizeSessionUseCase, gduc *usecase.GetMemoryDetailUseCase) {
	svc = s
	sessionSvc = ss
	syncUC = suc
	suggestUC = stuc
